    ...
    <div className="flex  h-screen bg-background bg-cover bg-fixed bg-center bg-no-repeat">
      ...
      <div className="w-1/3 flex flex-col gap-28 items-center h-screen justify-center ml-20">
          ...
          <div className="w-full flex flex-col gap-5 mb-16">
            ...
            <p  onClick={handleOpt} className="absolute z-10 text-white text-5xl h-14 w-52 mb-8 text-center">PLAY</p>
            </div>
            <div className="relative flex justify-center items-center">
            <img src={but} alt=""  className="w-56"/>
            <p className="absolute z-10 text-white text-5xl h-14 w-30 mb-8 mr-4 text-center">OPTIONS</p>
            </div>
            <div className="relative flex justify-center items-center">
            <img src={but} alt="" className="w-56"/>
            <p  onClick={handleKlik}  className="absolute z-10 text-white text-5xl h-14 w-52 mb-8 text-center">EXIT</p>
            </div>
          </div>
      </div>
    </div>
